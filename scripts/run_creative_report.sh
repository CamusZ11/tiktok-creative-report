...
export TIKTOK_APP_ID="$(/usr/bin/security find-generic-password -s com.codex.tiktok-workflow.app-id -a default -w)"
export TIKTOK_APP_SECRET="$(/usr/bin/security find-generic-password -s com.codex.tiktok-workflow.app-secret -a default -w)"
